...
<!-- section content end -->
<!-- section content begin -->
<div class="uk-section in-equity-2 uk-background-contain uk-background-center" data-src="{{ asset('') }}img/in-equity-2-bg.png" data-uk-img>
    <div class="uk-container uk-margin-top">
        <div class="uk-grid uk-flex uk-flex-center">
            ...
            <div class="uk-width-3-4@m uk-margin-medium-top">
                <img class="uk-align-center" src="{{ asset('') }}img/in-lazy.gif" data-src="{{ asset('') }}img/in-equity-2-img.png" alt="image" width="758" height="334" data-uk-img>
            </div>
                ...
                <div class="uk-grid uk-child-width-1-4@m uk-child-width-1-4@s uk-text-center in-feature-box" data-uk-grid>
                    <a href="#">
                        <span class="in-icon-wrap">
                            <img src="{{ asset('') }}img/in-lazy.gif" data-src="{{ asset('') }}img/in-equity-2-icon-1.svg" alt="icon-1" width="35" height="42" data-uk-img>
                        </span>
                        <p class="uk-margin-top">Trading calculators</p>
                    </a>
                    <a href="#">
                        <span class="in-icon-wrap">
                            <img src="{{ asset('') }}img/in-lazy.gif" data-src="{{ asset('') }}img/in-equity-2-icon-2.svg" alt="icon-2" width="38" height="42" data-uk-img>
                        </span>
                        <p class="uk-margin-top">Market analysis</p>
                    </a>
                    <a href="#">
                        <span class="in-icon-wrap">
                            <img src="{{ asset('') }}img/in-lazy.gif" data-src="{{ asset('') }}img/in-equity-2-icon-3.svg" alt="icon-3" width="42" height="42" data-uk-img>
                        </span>
                        <p class="uk-margin-top">Market reviews</p>
                    </a>
                    <a href="#">
                        <span class="in-icon-wrap">
                            <img src="{{ asset('') }}img/in-lazy.gif" data-src="{{ asset('') }}img/in-equity-2-icon-4.svg" alt="icon-4" width="42" height="42" data-uk-img>
                        </span>
...
<div class="uk-section uk-preserve-color uk-padding-remove uk-margin-remove uk-height-viewport uk-background-white">
    <div class="uk-container-expand uk-margin-remove">
        <div class="uk-grid-collapse uk-flex-middle" data-uk-grid>
            ...
            <div class="uk-width-3-5 uk-width-expand@m" style="margin: 0; padding: 0; height: 100vh; display: flex; justify-content: center; align-items: center;">
